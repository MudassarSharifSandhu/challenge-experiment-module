...
const renderExperimentCard = (item, updateExperiment, toggleLock) => {
  render(<ExperimentCard item={item} updateExperiment={updateExperiment} toggleLock={toggleLock} />)
}
...
test('generates an iteration', () => {
  ...
  renderExperimentCard(mockItem, updateExperimentMock, () => {})
  ...
  expect(updateExperimentMock).toHaveBeenCalledWith(mockItem.id, {
    ...mockItem,
    iterations: [
      ...mockItem.iterations,
      {
